...
baseDir = '/data/jiangang/flatness_6_11_11/rightside/'
...
l0,lerr0=offset(CCD1='n10',CCD2='n4',cat=cat,xadd=60,yadd=0,sep=70,crit_f=0)
l1,lerr1=offset(CCD1='n4',CCD2='n10',cat=cat,xadd=-60,yadd=0,sep=70,crit_f=0)
