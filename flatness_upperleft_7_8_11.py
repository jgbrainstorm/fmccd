...
baseDir = '/data/jiangang/flat_allccd_7_8_11/upperleft/'
...
ext=['i30s','i31s','i28s','i27s','i22s','i23s','i24s','i19s','i18s','i17s','i11s','i12s','i13s','i7s','i6s','i5s','i4s','i4n','i5n','i6n','i7n']
